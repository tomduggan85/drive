...
export const VEHICLE_DEFS = {
  its_a_volvo: {
    ...
    torque: 4000,
    chassisMass: 5000,
    chassisShape: { offset: { x: -1, y: 8, z: 0 }, size: { x: 25, y: 3, z: 12} },
    bodyShapes: [
  ...
  lada: {
    ...
    maxVel: 200,
    torque: 4000,
    chassisShape: { offset: { x: -1, y: 8, z: 0 }, size: { x: 29, y: 3, z: 12} },
    chassisMass: 5000,
    bodyShapes: [
  ...
  '50s': {
    ...
    torque: 3000,
    chassisMass: 5000,
    chassisShape: { offset: { x: -1, y: 8, z: 0 }, size: { x: 33.5, y: 3, z: 12} },
    bodyShapes:  [
  ...
  'pontiac': {
    ...
    torque: 3000,
    chassisMass: 5000,
    chassisShape: { offset: { x: -1, y: 8, z: 0 }, size: { x: 33.5, y: 3, z: 11.5} },
    bodyShapes: [
  ...
  woodywagon: {
    ...
    torque: 3000,
    chassisMass: 5000,
    chassisShape: { offset: { x: -1, y: 8, z: 0 }, size: { x: 34, y: 3, z: 11.5} },
    bodyShapes: [
