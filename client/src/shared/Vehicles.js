...
export const VEHICLE_DEFS = {
  its_a_volvo: {
    ...
    torque: 4000,
    chassisMass: 4000,
    chassisShape: { offset: { x: -1, y: 8, z: 0 }, size: { x: 25, y: 3, z: 11} },
    bodyShapes: [
      { offset: { x: -1, y: 2, z: 0 }, size: { x: 32, y: 3, z: 12} },
  ...
  lada: {
    ...
    chassisMass: 4000,
    bodyShapes: [
      { offset: { x: -1, y: 2, z: 0 }, size: { x: 29, y: 3, z: 12} },
  ...
  '50s': {
    ...
    rideHeight: 5.7,
    suspensionTravel: 3,
    suspensionStiffness: 170000,
    suspensionDamping: 0.0000025,
  },
  ...
  'pontiac': {
    ...
    bodyShapes: [
      { offset: { x: -1, y: 2, z: 0 }, size: { x: 33.5, y: 3, z: 11.5} },
  ...
  woodywagon: {
    ...
    chassisShape: { offset: { x: -1, y: 8, z: 0 }, size: { x: 30, y: 3, z: 10} },
    bodyShapes: [
      { offset: { x: -1, y: 2, z: 0 }, size: { x: 34, y: 3, z: 11.5} },
